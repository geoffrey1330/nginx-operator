...
import (
	...
	"github.com/geoffrey1330/nginx-operator/controllers/metrics"
...
//+kubebuilder:rbac:groups=operator.geoffrey.com,resources=nginxoperators,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.geoffrey.com,resources=nginxoperators/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.geoffrey.com,resources=nginxoperators/finalizers,verbs=update
